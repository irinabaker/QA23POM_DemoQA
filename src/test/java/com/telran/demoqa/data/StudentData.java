...
public class StudentData {
    ...
    public static final  String LAST_NAME = "Sarrow";
    ...
    public static final  String[] SUBJECTS = {"Maths","Chemistry","Computer Science"};
    public static final  String[] HOBBIES = {"Sports","Reading","Music"};
    public static final  String PHOTO_URL = "C:/Tools/12.png";
